...
class RegisterProd {
    ...
    public function register_all_scripts() {
        ...
        wp_register_script( ScriptName::PAGE_SETTINGS, FLEXA_RETAILERS_MANAGEMENT_PLUGIN_URL . 'assets/dist/admin/js/main.js', $deps, FLEXA_RETAILERS_MANAGEMENT_VERSION, true );
        ...
        wp_register_script( ScriptName::PAGE_PRODUCT_RETAILERS, FLEXA_RETAILERS_MANAGEMENT_PLUGIN_URL . 'assets/dist/admin/js/product-retailers.js', $deps, FLEXA_RETAILERS_MANAGEMENT_VERSION, true );
        ...
        wp_register_script( ScriptName::PAGE_PRODUCT_RETAILERS_FRONTEND, FLEXA_RETAILERS_MANAGEMENT_PLUGIN_URL . 'assets/dist/frontend/js/product-retailers-frontend.js', $frontend_deps, FLEXA_RETAILERS_MANAGEMENT_VERSION, true );
